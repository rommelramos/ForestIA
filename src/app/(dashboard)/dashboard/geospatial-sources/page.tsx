  ...
  return (
    <div className="p-8 space-y-6">
      <div className="flex items-center gap-3">
        <h1 className="text-2xl font-bold text-gray-900">Bases Geoespaciais</h1>
        <Badge variant="outline" className="text-yellow-700 border-yellow-300">Em desenvolvimento</Badge>
      </div>
      <Card>
        <CardHeader>
          <CardTitle className="text-base text-gray-600">Módulo 2 — Catálogo de bases geoespaciais</CardTitle>
        </CardHeader>
